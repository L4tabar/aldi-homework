...
If you find hard to see what was implemented in the 2nd task (because the same framework setup is used for the 3rd task as well), I'd suggest to check the related PR.
